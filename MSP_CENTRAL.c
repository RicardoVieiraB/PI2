...
void servo_molho()                   //controla servo da bomba de molho
{
    ...
    TA0CCR1 = 60;                   //inicia com duty de 12% p/ posição 180°
    TA0CCR2 = 2540;
    TA0CCR0 = TA0CCR2;
    ...
    while(k<=1)
    {
        ...
        if(i==50){                    //valores para 0°
            TA0CCR1 = 60;             //duty de 2,5%
            TA0CCR2 = 2540;
            TA0CCR0 = TA0CCR2;
        }
        if(i==100){                   //valores para 180°
            TA0CCR1 = 100;            //duty de 12%
            TA0CCR2 = 2500;
            TA0CCR0 = TA0CCR2;
         }
        if(i==150){                    //valores para 0°
            TA0CCR1 = 150;             //duty de 2,5%
            TA0CCR2 = 2450;
            TA0CCR0 = TA0CCR2;
        }
        if(i==200){                    //valores para 0°
            TA0CCR1 = 200;             //duty de 2,5%
            TA0CCR2 = 2400;
            TA0CCR0 = TA0CCR2;
        }
        if(i==250){                    //valores para 0°
            TA0CCR1 = 250;             //duty de 2,5%
            TA0CCR2 = 2350;
            TA0CCR0 = TA0CCR2;
        }
        if(i==300){                    //valores para 0°
            TA0CCR1 = 300;             //duty de 2,5%
            TA0CCR2 = 2300;
            TA0CCR0 = TA0CCR2;
            i=0;
            k++;
